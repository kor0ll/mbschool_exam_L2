...
Плюсами стратегии являются возможность замены алгоритмов во время исполнения программы, изоляция код алгоритмов и реализация принципа открытости/закрытости
